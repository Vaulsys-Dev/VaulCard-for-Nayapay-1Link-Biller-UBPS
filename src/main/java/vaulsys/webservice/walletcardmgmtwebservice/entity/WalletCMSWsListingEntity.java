...
//    }
    ...
    public WalletCMSWsListingEntity copy(WalletCMSWsEntity cmsWsEntity) {
        ...
        //Arsalan Akhter, Date: 01-Feb-2022, Ticket: VC-NAP-202202011(Wallet Statement Issue - Production)
        this.setIncludeinstatement(cmsWsEntity.getIncludeinstatement());
        this.setOpeningbalance(cmsWsEntity.getOpeningbalance());
        this.setClosingbalance(cmsWsEntity.getClosingbalance());
        this.setDestOpeningbalance(cmsWsEntity.getDestOpeningbalance());
        this.setDestClosingbalance(cmsWsEntity.getDestClosingbalance());
        //================================================================================================
